...
//             size,
//             data_block_len: 0,
//             free_block_ptr: free_block_offset,
//             free_block_len: 0,
//         }
//     }

//     fn is_enuogh_for_data_record(&self) -> bool {
//         (self.data_block_len + 1) * size_of::<DataBlock>() <= self.free_block_ptr
//     }

//     fn is_enough_for_free_block(&self) -> bool {
//         self.free_block_ptr + (self.free_block_len + 1) * size_of::<MemoryBlock>() <= self.size
//     }
...
//         self.data_block_ptr = new_ptr;
//         self.size = new_size;
//     }

//     fn get_data_block(&self, descriptor: &Descriptor) -> &DataBlock {
//         unsafe {
//             let ptr = self.data_block_ptr.cast::<DataBlock>().as_ptr().add(descriptor.0);
//             let ref_ = &*ptr;
//             ref_
//         }
//     }
...
//         let header_pages = 1;
//         let mut header = Header::new(ptr, header_pages * page_size);
